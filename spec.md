...
The brief view of the system is shown below. The system can be divided into two phases, the **flow capturing phase** and the **policy generating phase**. A flow file will be generated by flow capturing and it will be read by policy generator to generate policies.
